        ...
        {project && organizationPool ? (
          <>
            ...
            <Content component="p" className="tenant-admin-quota-distribution__attach-note">
              This project will use your assigned external IP pool for routable public address
              exposure. Only the pool inherited from your provider administrator can be attached.
            </Content>
          </>
        ) : null}
      </ModalBody>
